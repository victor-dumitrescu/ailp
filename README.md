# AILP - Artificial Intelligence Large Practical
School of Informatics, The University of Edinburgh, 2013

## How to run

In a terminal, compile the main module using `ghc Main.lhs`.
Then run it using `./Main`. The system will ask for the name of
an input file you want to use. The Readme also serves as an input
...
Names of proposition must start with a letter or a minus sign and 
